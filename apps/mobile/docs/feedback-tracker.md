...
| Editor text should not ghost or duplicate during scroll/drag transitions | Partial | Native phone gesture proof reproduced and fixed a committed-swipe duplicate-layer bug in the phone transition preview. Still needs a WYSIWYG scroll-specific stress pass before marking fully done. |
