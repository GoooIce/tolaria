...
export const mobileParityInventory = [
  ...
  {
    assertions: ['markdown formatting command user-flow checks for inline marks, H1-H6 headings, lists, blocks, wikilinks, and tables'],
    contracts: ['desktopToolbarActionParity'],
