...
export const mobileParityInventory = [
  ...
  {
    assertions: ['TenTap native simulator rendering', 'document-content serialization with desktop highlight, display math, hard-break, unsupported-table, and image regression checks'],
