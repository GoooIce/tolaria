...
export const mobileParityInventory = [
  ...
  {
    assertions: ['TenTap native simulator rendering', 'native WYSIWYG layout metric contract', 'native WYSIWYG bridge mutation/save proof', 'native WYSIWYG Expo FileSystem persistence proof', 'native WYSIWYG formatting command mapping tests', 'native WYSIWYG full-document save serialization tests', 'Tolaria-owned native formatting toolbar for supported rich commands', 'document-content hydration and serialization with raw frontmatter, desktop highlight, escaped inline markdown punctuation, wikilink alias/no-alias, angle-wrapped attachment links, URL/email autolinks, bare URL/email save preservation, image titles, remote image URLs with balanced parentheses, inline image source paragraphs, empty headings, empty list items, mixed nested list kinds, list continuation and list hard-break source blocks, non-1 ordered list starts, ordered-paren and repeated-marker source lists, blank blockquotes, display math, hard-break, blockquote paragraphs, unsupported-table, details/html-comment blocks, root image, and indented image/heading/list/code-fence/display-math/text source regression checks'],
