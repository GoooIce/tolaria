...
export const mobileParityInventory = [
  ...
  {
    assertions: ['TenTap native simulator rendering', 'document-content hydration and serialization with raw frontmatter, desktop highlight, wikilink alias/no-alias, display math, hard-break, blockquote paragraphs, unsupported-table, details/html-comment blocks, root image, and indented image/heading/list/code-fence/display-math/text source regression checks'],
